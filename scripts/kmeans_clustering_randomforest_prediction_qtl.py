...
class Columns2Clustering:
    ...
    def plot_kmeans(clusterer, X):
        ...
        def plot_decision_boundaries(clusterer, X, resolution=1000, show_centroids=True, show_xlabels=True, show_ylabels=True):
            ...
            if show_ylabels:
                plt.ylabel("Transformed chromosome number", fontsize=20, rotation=90)
            else:
    ...
    def visualize_plot(plot_kmeans, clusterer, X_train, index):
        ...
        plt.savefig(os.path.join(out_dir, f"Project_KMeans_clustering_RandomForest_prediction_result_by_qtl_{index}"))
        plt.show()
    ...
    def visualize_plot_annotation(X_valid, y_supervised_pred, index, type_anno):
        ...
        plt.savefig(os.path.join(out_dir, f"Project_KMeans_clustering_RandomForest_{type_anno}_annotation_result_by_qtl_{index}"))
        plt.show()
