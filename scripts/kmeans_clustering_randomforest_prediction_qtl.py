...
class Columns2Clustering (ModellingKMeans):
    ...
    def visualize_plot(plot_kmeans, clusterer, X_train):
        ...
        plt.savefig(os.path.join(out_dir, f"Project_PCA_KMeans_clustering_RandomForest_prediction_result_by_qtl"))
        plt.show()
...
print(f"Execution time for kmeans_clustering_randomforest_prediction_qtl.py is : {time_taken} seconds")
