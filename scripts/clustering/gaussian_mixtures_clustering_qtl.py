...
def main():
    ...
    if os.path.exists('gaussian_clustering/gaussian_clustering_qtl.pkl'):
        ...
        actual_clustering=joblib.load('gaussian_clustering/gaussian_clustering_qtl.pkl')
        ...
        joblib.dump(actual_clustering, 'gaussian_clustering/gaussian_clustering_qtl.pkl')
